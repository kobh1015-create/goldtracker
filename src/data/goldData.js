...
export const MINES = [
  { id: 1,  name: '구봉금광',  lat: 36.41519, lng: 126.76567, region: '충남 청양군', river: '지천',    address: '충남 청양군 남양면 구룡리',  notes: '금/은 — 한때 동양 최대 규모' },
  { id: 2,  name: '임천금광',  lat: 36.24853, lng: 126.89900, region: '충남 부여군', river: '금강',    address: '충남 부여군 임천면',         notes: '금/은' },
  { id: 3,  name: '예산금광',  lat: 36.49851, lng: 126.78233, region: '충남 예산군', river: '삽교천',  address: '충남 예산군',                notes: '금' },
  { id: 4,  name: '덕음금광',  lat: 34.99861, lng: 126.59903, region: '전남 영광군', river: '불갑천',  address: '전남 영광군',                notes: '금/은/납/아연' },
  { id: 5,  name: '김제금광',  lat: 35.74856, lng: 126.91568, region: '전북 김제시', river: '동진강',  address: '전북 김제시',                notes: '금/은' },
  { id: 6,  name: '월류금광',  lat: 36.22632, lng: 127.89481, region: '충북 옥천군', river: '보청천',  address: '충북 옥천군',                notes: '금/은' },
  { id: 7,  name: '무극금광',  lat: 36.98182, lng: 127.41565, region: '충북 음성군', river: '청미천',  address: '충북 음성군',                notes: '금/은/구리' },
  { id: 8,  name: '성남금광',  lat: 36.71518, lng: 127.49898, region: '충북 청주시', river: '미호천',  address: '충북 청주시',                notes: '금' },
  { id: 9,  name: '태창금광',  lat: 37.06516, lng: 127.76841, region: '강원 원주시', river: '섬강',    address: '강원 원주시',                notes: '금/은' },
  { id: 10, name: '동진금광',  lat: 35.71523, lng: 127.31567, region: '전북 완주군', river: '만경강',  address: '전북 완주군',                notes: '구리/금/은' },
  { id: 11, name: '일광금광',  lat: 35.30416, lng: 129.22674, region: '부산 기장군', river: '일광천',  address: '부산 기장군 일광읍',         notes: '구리/은/금 — 유명 금광' },
  { id: 12, name: '고흥금광',  lat: 34.59863, lng: 127.24901, region: '전남 고흥군', river: '고흥천',  address: '전남 고흥군',                notes: '구리/금/은' },
  { id: 13, name: '수복광산',  lat: 36.19854, lng: 127.44899, region: '충남 공주시', river: '금강',    address: '충남 공주시',                notes: '구리/아연/은/금' },
  { id: 14, name: '운곡금광',  lat: 37.01517, lng: 128.34340, region: '충북 제천시', river: '달천',    address: '충북 제천시',                notes: '납/아연/구리/금/은' },
  { id: 15, name: '부덕광산',  lat: 37.33180, lng: 126.49900, region: '경기 화성시', river: '남양호',  address: '경기 화성시',                notes: '텅스텐/은/구리/금' },
]

// 각 광산 5km 내외 하류 하천 굽이 (Point Bar)
export const POINT_BARS = [
  ...
  { id: 'pb6',  name: '섬강 태창 하류 굽이',  river: '섬강',   address: '강원 원주시',        coords: [[37.1071,127.7641],[37.1111,127.7711],[37.1081,127.7791]] },
  ...
  { id: 'pb10', name: '달천 운곡 하류 굽이',  river: '달천',   address: '충북 제천시',        coords: [[37.0531,128.3391],[37.0571,128.3461],[37.0541,128.3541]] },
]
...
// 각 폐금광 3~8km 하류 유망 구간 (USGS 좌표 기반)
export const CANDIDATES = [
  ...
  { id: 'hot9',  name: '태창금광 하류 섬강',   lat: 37.1101, lng: 127.7681, address: '강원 원주시 섬강변'          },
  { id: 'hot10', name: '동진금광 하류 만경강', lat: 35.7151, lng: 127.2601, address: '전북 완주군 만경강변'        },
  ...
  { id: 'hot13', name: '운곡금광 하류 달천',   lat: 37.0531, lng: 128.3431, address: '충북 제천시 달천변'          },
]
